...
const fs = require('fs');
const jwt = require('jsonwebtoken'); // Added JWT dependency
...
const JWT_SECRET = process.env.JWT_SECRET || 'your_jwt_secret_key_here'; // Add to .env file
...
// New: Protected profile route to fetch user details
